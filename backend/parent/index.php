<?php
    ...
    if(isset($_POST['prnt_login']))
    {
        ...
        if($rs)
            {//if its sucessfull
                header("location:his_prnt_dashboard.php");
            }
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="prnt_pwd" type="password" required="" id="password" placeholder="Enter your password">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="his_prnt_reset_pwd.php" class="text-white-50 ml-1">Forgot your password?</a></p>
